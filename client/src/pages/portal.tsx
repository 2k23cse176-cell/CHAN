  ...
  if (step === "login") {
    return (
      <div style={{
        ...
        <div className="chan-glow-wrap" style={{ width: "100%", maxWidth: 400 }}>
          <div className="chan-card" style={{ padding: "40px 28px 36px" }}>
            <div style={{ textAlign: "center", marginBottom: 28 }}>
              <img src={logoPath} alt="CHAN CORP KEYAUTH" style={{ width: 72, height: 72, borderRadius: "50%", marginBottom: 14, display: "block", margin: "0 auto 14px" }} />
              <span className="chan-brand" style={{ display: "block", fontSize: 18, marginBottom: 4, letterSpacing: 3, color: "#fff" }}>CHAN CORP KEYAUTH</span>
            ...
            <p style={{ textAlign: "center", marginTop: 20, fontSize: 11, color: "#2a1a3e" }}>
              &copy; 2026 CHAN CORP KEYAUTH &mdash; Secure Auth Panel
            </p>
          </div>
        </div>
      </div>
    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <img src={logoPath} alt="CHAN CORP KEYAUTH" style={{ width: 36, height: 36, borderRadius: "50%" }} />
          <div>
            <span style={{ fontFamily: "Rajdhani, sans-serif", fontWeight: 800, fontSize: 16, color: "#fff", letterSpacing: 2 }}>CHAN CORP</span>
