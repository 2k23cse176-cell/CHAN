...
import newLogoPath from "@assets/chan-corp-logo-white.png";
        ...
        <Link href="/dashboard" className="flex items-center gap-3">
          <img
            ...
            style={{
              ...
              filter: "drop-shadow(0 0 6px rgba(139,92,246,0.65)) drop-shadow(0 0 14px rgba(0,200,255,0.25))",
            }}
          />
          <span style={{ fontSize: 9, color: "#52525b", letterSpacing: "1px", textTransform: "uppercase", marginTop: 2 }}>Auth Panel</span>
        </Link>
      </SidebarHeader>
